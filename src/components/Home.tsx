...
const Home = () => {
  return (
    <div
    //   name="Home"
      className="h-screen w-full bg-gradient-to-b from-black to-gray-800 mb-0"
    >
      <div className=" max-w-screen-lg mx-auto flex-col flex items-center justify-center h-full px-4 md:flex-row">
        <div className="  flex flex-col justify-center h-full">
          ...
          <p className="text-gray-300 max-w-md py-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio
            quisquam magni, nam consequatur fugit, quo alias laborum dolorum
            fuga natus, modi necessitatibus possimus saepe veniam!
          </p>
          <div>
        ...
        <div>
          <img
            src={HeroImage}
            alt="my-profile"
            className=" rounded-2xl mx-auto w-2/3 md:w-2/3 scale-60"
          />
        </div>
      </div>
    </div>
